...
*v3: Fixed indents, replaced < with lt, removed a comment, fixed additional instances of justification. Tested on VTL.;
...
proc report data = fp.kopanski_means_freq nowd 
  ...
  compute stu_rating;
    ...
    if stu_rating ge 0 and stu_rating lt 60 then call define('Studio', 'Style', 'Style = [backgroundcolor=cx980043]');
      else if stu_rating ge 60 and stu_rating lt 70 then call define('Studio', 'Style', 'Style = [backgroundcolor=cxdd1c77]');
      else if stu_rating ge 70 and stu_rating lt 80 then call define('Studio', 'Style', 'Style = [backgroundcolor=cxdf65b0]');
      else if stu_rating ge 80 and stu_rating lt 90 then call define('Studio', 'Style', 'Style = [backgroundcolor=cxd7b5d8]');

...
proc transpose data = RawData.pm10 out = HW7.pm10_T(rename = (_NAME_ = _DAY COL1 = aqs COL2 = aqi COL3 = count));
...
proc sort data = RawData.methods
  out = HW7.methods_2;
  by aqscode;
run;

data HW7.HW7FinalKopanski(drop = day StCode CountyCode SiteNum) 
  HW7.HW7FinalKopanski100;
  attrib 

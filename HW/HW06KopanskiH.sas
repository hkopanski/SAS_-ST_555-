/*
 ...
 v5 :Added proc format for metro_desc and modified Section 4 to incorporate format. 
*/
...
/* Create formats to be used in this script. */
...
data HW6.KopanskiIPUMS2005;
  ...
  MetroDesc = put(metro, metro_desc.);
  by Serial;
run;
/* End of Section 4 */

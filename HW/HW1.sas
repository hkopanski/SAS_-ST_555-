...
@Project: ST555
@Purpose: Create a summary report from the cars dataset
...
proc print data = HW1.cars_srtd noobs label;
  ...
  format MSRP dollar12. Invoice dollar12.;
run;
...
*Frequncy summary table of sorted data. This table excludes Acura and Landrover.;

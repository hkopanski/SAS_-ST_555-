...
/* Project= HW06             */
/* Purpose = To create a     */
/* comprehensive report on housing status in various Regions */
/* Date Created = 11MAR2020  */
/* Date Modified = N/A*/
/* N/A */

/*Location of raw and validation files*/
x 'cd C:\Users\halid\Documents\SASUniversityEdition\myfolders\HW06';
libname inputds ".";
filename RawData ".";
/*Location of all files*/
x 'cd C:\Users\halid\Documents\SASUniversityEdition\myfolders\HW06_Results';
libname HW6 ".";
filename HW6 ".";
...
data hw6.kopanski_fc_ren(drop = FIPS);
  attrib  Serial       length = 8.         label = 'Household Serial Number'
          ...
          MortStat     length = $45        label = 'Mortgage Status'
          Ownership    length = $6         label = 'Ownership Status';
  set inputds.FreeClear(in = freein)
      inputds.Renters (in = rentin);
...
proc contents data = hw6.Kopanski_merged varnum;
...
ods pdf file = 'HW6 Kopanski IPUMS Report.pdf' DPI = 300 startpage = never;
...
proc report data = hw6.Kopanski_merged;
...
proc univariate data = hw6.Kopanski_merged;
...
proc sgplot data = hw6.Kopanski_merged;
...
proc sgpanel data = hw6.Kopanski_merged noautolegend;
